...
function twentyseventeen_nav_menu_social_icons( $item_output, $item, $depth, $args ) {
	...
	// DC 15 mars 2017 - pour adresser aussi la version English
	if ( 'social' === $args->theme_location || 'en-social' === $args->theme_location ) {
...
function twentyseventeen_social_links_icons() {
	...
	$social_links_icons = array(
		...
		'/nous-contacter'         => 'envelope-o',
		'/en/contact-us'         => 'envelope-o',
		'/en/'     => 'flag-en',
		'/fr/'     => 'flag-fr',
	);
