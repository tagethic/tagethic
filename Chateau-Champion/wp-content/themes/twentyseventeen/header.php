...
<div id="page" class="site">
	...
	<?php
		/* Ajout de la Disclaimer notice 
		 * DC 8 mars 2017
		 */
		if(!isset($_SESSION["nodisclaimer"])) {
			// Voir aussi wp-includes/post-template.php body_class() - ajout de 'dsclm'
			if($langue=="en") {
			?>
		<div id="dsclm"><div>
			<p>Welcome to <br>Château Champion</p>
			<p>By entering this site, I certify that I am of legal drinking age in my country of residence.</p>
			<p><button class="btn-oui">Yes</button> <button class="btn-non">No</button></p>
			<p>&nbsp;</p>
		</div></div><div id="odsclm"></div>	
			<?php
			} else {
		?>
		<div id="dsclm"><div>
			<p>Bienvenue sur le site de <br>Château Champion</p>
			<p>Êtes-vous en âge de consommer de l’alcool dans votre pays de résidence ?</p>
			<p><button class="btn-oui">Oui</button> <button class="btn-non">Non</button></p>
			<p>L'abus d'alcool est dangereux pour la santé, <br>sachez consommer avec modération.</p>
		</div></div><div id="odsclm"></div>
	<?php
			}
		}
