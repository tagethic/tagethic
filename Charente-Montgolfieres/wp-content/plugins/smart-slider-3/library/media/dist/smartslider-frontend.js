...
(function ($, scope, undefined) {
    ...
    NextendSmartSliderLoad.prototype.start = function () {
        if (this.parameters.scroll) {
            ...
            $.when(this.smartSlider.responsive.ready, this.smartSlider.backgroundImages.load, this.smartSlider.sliderElement.find('.n2-ss-layers-container').n2imagesLoaded()).done($.proxy(this.showSlider, this));
    ...
    NextendSmartSliderAbstract.prototype.__postInit = function (id, sliderElement, parameters) {
        ...
        this.sliderElement.on({
            universalenter: $.proxy(function (e) {
                if (!$(e.target).closest('.n2-ss-widget').length) {
...
(function ($, scope, undefined) {
    ...
    NextendSmartSliderVimeoItem.prototype.initVimeoPlayer = function () {
        var playerElement = n2('<iframe id="' + this.playerId + '_video" src="https://player.vimeo.com/video/' + this.parameters.vimeocode + '#t=' + this.start + '?autoplay=0&' +
