...
function create_post_type() {
  register_post_type( 'grilleaccueil',
    array(
      'labels' => array(
        'name' => __( 'GrilleAccueil' ),
        'singular_name' => __( 'GrilleAccueil' )
      ),
      'public' => true,
	  'supports' => array( 'title', 'editor', 'thumbnail', 'revisions')   // , 'excerpt' )
    )
  );
  register_taxonomy( 'bloc', 'grilleaccueil', array( 'hierarchical' => true, 'label' => 'Bloc', 'query_var' => true, 'rewrite' => false ) );
...
function cd53_scripts() {
	wp_enqueue_style( 'cd53', get_template_directory_uri() . '/_cd53/cd53-cm.css?5' );
	wp_enqueue_script( 'cd53', get_template_directory_uri() . '/_cd53/cd53-cm.js', array(), '20170515', true );
}
...
function insert_fb_in_head() {
	...
	if ( !is_singular()) //if it is not a post or a page
		...
		$desc = ( is_single() ?  single_post_title('', false): get_bloginfo('name') . ' - ' . get_bloginfo('description') );
        ...
        echo '<meta property="og:site_name" content="Charente Montgolfières"/>';
...
//
//Mise en place du hook d'action pour Contact Form 7
//
