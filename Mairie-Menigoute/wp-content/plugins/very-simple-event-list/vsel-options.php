...
function vsel_admin_init() {
	...
	add_settings_field( 'vsel-field-7', __( 'Info', 'very-simple-event-list' ), 'vsel_field_callback_7', 'vsel', 'vsel-section-2' );
...
function vsel_field_callback() {
	...
	<label><input type='checkbox' name='vsel-setting' <?php checked( $value, 'yes' ); ?> value='yes'> <?php _e( 'Do not delete events and settings when uninstalling plugin.', 'very-simple-event-list' ); ?></label>
	<?php
}
